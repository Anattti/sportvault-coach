  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4">
        <div>
          <Button variant="ghost" size="sm" render={<Link href={`/clients/${clientId}/sessions`} />} nativeButton={false} className="mb-2 -ml-2 text-muted-foreground hover:text-foreground">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            {sessionData.workout_id && (
              <Button
                ...
                render={
                  <Link href={`/clients/${clientId}/sessions/workout/${sessionData.workout_id}`} />
                }
                nativeButton={false}
              >
